...
def getTemp(month,monthNo):
	query = "SELECT Value,month,Year FROM tempurature_past where month='"+month+"' and District = 'Galle' and Year BETWEEN '2010' AND '2013'"
	data = dbQuery(query)
	data = np.array(data) 
...
query = "SELECT Value,month FROM tempurature_past where District = 'Galle' and Year = '2014'"
