...
def predicRainfal(month,monthNo):
	query = "SELECT Value,month,Year FROM rainfall_past where month='"+month+"' and District = 'Colombo' and Year BETWEEN '2006' AND '2014'"
	data = dbQuery(query)
	data = np.array(data) 
...
query = "SELECT Value,month FROM rainfall_past where District = 'Colombo' and Year = '2015'"
